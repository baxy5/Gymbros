  ...
  return (
    <div className='h-screen flex flex-col justify-center items-center w-full'>
      ...
      <form className='flex flex-col w-72' onSubmit={createActivity}>
        ...
        <input name="duration" required type="text" placeholder='Workout session (minute)' className='p-1 border-solid border-2 border-color-six' />
        ...
        <input name="calorie" required type="text" placeholder='Calorie consumption today' className='p-1 border-solid border-2 border-color-six' />
        <label className='my-2 font-bold text-lg'>Weight</label>
        <input name="weight" required type="text" placeholder='Your actual weight (kg)' className='p-1 border-solid border-2 border-color-six' />
